# The Preload Package [![Build Status](https://github.com/joomla-framework/preload/actions/workflows/ci.yml/badge.svg?branch=3.x-dev)](https://github.com/joomla-framework/preload)
